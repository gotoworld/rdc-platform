package com.hsd.devops.core.mutidatasource.aop;

import com.hsd.devops.core.mutidatasource.DataSourceContextHolder;
...
public class MultiSourceExAop implements Ordered {
    ...
    @Pointcut(value = "@annotation(com.hsd.devops.core.mutidatasource.annotion.DataSource)")
    private void cut() {
