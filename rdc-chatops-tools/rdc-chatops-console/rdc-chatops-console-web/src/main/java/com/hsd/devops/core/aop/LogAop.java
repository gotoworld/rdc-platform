...
import com.hsd.devops.common.constant.dictmap.factory.DictMapFactory;
...
import com.hsd.devops.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.hsd.devops.common.annotion.BussinessLog)")
