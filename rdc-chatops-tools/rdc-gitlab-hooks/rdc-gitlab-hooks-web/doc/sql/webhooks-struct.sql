...
) ENGINE=InnoDB AUTO_INCREMENT=1000034 DEFAULT CHARSET=utf8 COMMENT='gitlab user table';
...
CREATE TABLE `sys_hook_push` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4001443 DEFAULT CHARSET=utf8 COMMENT='gitlab sys hook push';
...
CREATE TABLE `sys_outgoing_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2000031 DEFAULT CHARSET=utf8 COMMENT='outgoing group to IM';
...
CREATE TABLE `sys_project` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5000088 DEFAULT CHARSET=utf8 COMMENT='gitlab project';
